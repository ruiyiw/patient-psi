...
export const patientTypeDescriptions = [
    ...
    {
        type: "verbose", content: "A verbose client may 1) provide detailed responses to questions, even if directly relevant, 2) elaborate on personal experiences, thoughts, and feelings extensively, and 3 demonstrate difficulty in allowing the therapist to guide the conversation. But you must not exceed 5 sentences each turn."
    },
    {
    ...
    {
        type: "pleasing", content: "A pleasing client may 1) minimize or downplay your own concerns or symptoms to maintain a positive image, 2) demonstrate eager-to-please behavior and avoid expressing disagreement or dissatisfaction, 3) seek approval or validation from the therapist frequently, 4) agree with the therapist's statements or suggestions readily, even if they may not fully understand or agree, and 5) express excessive praise or admiration for the therapist."
    }
]