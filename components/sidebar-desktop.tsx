...
export async function SidebarDesktop() {
  ...
  return (
    <div>
      ...
      <Sidebar className="peer absolute inset-y-0 z-30 hidden translate-x-full right-0 border-l bg-muted duration-300 ease-in-out data-[state=open]:translate-x-0 lg:flex lg:w-[360px] xl:w-[540px]">
        {/* @ts-ignore */}
